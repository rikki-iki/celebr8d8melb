...
compass = compassOptions.dirs({'config': options.rootPath.project + 'config.rb'});

options.theme = {
  root  : options.rootPath.project,
  css   : options.rootPath.project + compass.css + '/',
  sass  : options.rootPath.project + compass.sass + '/',
  js    : options.rootPath.project + compass.js + '/'
};
...
options.styleGuide = {
  ...
  css: [
    '/themes/melbs/css/style.css',
    '/themes/melbs/css/style-guide/chroma-kss-styles.css',
    '/themes/melbs/css/style-guide/kss-only.css',
  ],
  js: [
    '/themes/melbs/js/scripts.min.js',
  ],

  homepage: 'homepage.md',
  title: 'Melbourne Community Theme'
};
